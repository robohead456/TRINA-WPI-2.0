...
public:
    ...
    void process_camera_control(const geometry_msgs::Twist twist){
        ...
        joint_goal.joint_names[0] = ("trina2_1/right_arm_joint_1"); 
        joint_goal.joint_names[1] = ("trina2_1/right_arm_joint_2"); 
        joint_goal.joint_names[2] = ("trina2_1/right_arm_joint_3"); 
        joint_goal.joint_names[3] = ("trina2_1/right_arm_joint_4"); 
        joint_goal.joint_names[4] = ("trina2_1/right_arm_joint_5"); 
        joint_goal.joint_names[5] = ("trina2_1/right_arm_joint_6"); 
        joint_goal.joint_names[6] = ("trina2_1/right_arm_joint_7"); 
